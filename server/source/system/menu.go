...
func (i *initMenu) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	entities := []SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: false, ParentId: "0", Path: "recruit", Name: "recruit", Component: "view/recruit/index.vue", Sort: 4, Meta: Meta{Title: "招聘", Icon: "user"}},
		{MenuLevel: 0, Hidden: false, ParentId: "4", Path: "boss", Name: "boss", Component: "view/recruit/boss/index.vue", Sort: 1, Meta: Meta{Title: "boss", Icon: "user"}},
		...
		{MenuLevel: 0, Hidden: false, ParentId: "3", Path: "organization", Name: "organization", Component: "view/superAdmin/organization/list.vue", Sort: 7, Meta: Meta{Title: "组织架构", Icon: "avatar"}},
		{MenuLevel: 0, Hidden: false, ParentId: "3", Path: "position", Name: "position", Component: "view/superAdmin/position/list.vue", Sort: 8, Meta: Meta{Title: "岗位", Icon: "avatar"}},
