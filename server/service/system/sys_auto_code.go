...
import (
	...
	"errors"
	"fmt"
	ast2 "github.com/Luxii44/library/server/utils/ast"
	"io"
	"mime/multipart"
	"os"
	"path/filepath"
	...
	"github.com/Luxii44/library/server/resource/autocode_template/subcontract"
...
func Init(Package string) {
	...
	packageInjectionMap = map[string]astInjectionMeta{
		packageServiceName: {
			...
			importCodeF:  "github.com/Luxii44/library/server/%s/%s",
			packageNameF: "%s",
